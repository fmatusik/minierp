...
public class ProductMapper {
    ...
    public static Product toEntityWithoutCategoryAndStatus(ProductAddDto productAddDto) {
        return Product.builder()
                .id(productAddDto.getId())
                .name(productAddDto.getName())
                .price(productAddDto.getPrice())
    ...
    public static List<Product> toEntityListWithoutCategory(List<ProductAddDto> dtoList) {
        return dtoList.stream()
